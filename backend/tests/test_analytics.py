...
def test_get_analytics_all(client):
...
def test_get_analytics_with_category_filter(client):
...
def test_get_analytics_empty_range(client):
...
def test_get_analytics_no_matching_categories(client):
